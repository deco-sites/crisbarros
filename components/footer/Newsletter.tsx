    ...
    <div class="flex flex-col sm:flex-row items-center gap-6 sm:gap-20">
      <div class="flex flex-col gap-2 max-w-[400px]">
        ...
        <div className="flex flex-col">
          <input
            className="text-md w-[380px] mb-2 p-2 border-none outline-none"
            type="text"
            placeholder="NOME"
          />
          <div className="w-[364px] h-[1px] bg-footer-underline"></div>
          <input
            className="text-md w-[380px] border-none outline-none p-2 "
            type="text"
            placeholder="E-MAIL"
          />
      ...
      <div>
        <h1 className="text-textColor text-center text-sm font-bold">
          ATENDIMENTO
        </h1>
        <div>
