...
const variants = {
  ...
  icon:
    "h-[36px] p-2 rounded-full bg-transparent text-default border-transparent active:border-interactive disabled:text-subdued disabled:bg-interactive-inverse focus:outline-none",
};
